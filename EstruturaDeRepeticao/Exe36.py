...
monta_tabu = int(input("Digite o numero para a tabuada: "))
comeca_tabu = int(input("Digite o numero que começa a tabuada: "))
termina_tabu = int(input("Digite o numero que termina a tabuada: "))

for i in range(comeca_tabu, termina_tabu + 1):
    print("{} x {} = {}".format(monta_tabu, i, monta_tabu * i))
