...
além do limite e na variável multa o valor da multa que João deverá pagar. Imprima os dados do programa com a
mensagens adequadas."""
...
if peso <= 50:
    ...
    excesso = peso - 50
    multa = excesso * 4
    print("Peso -> {}. Excesso -> {}. Multa -> {}".format(peso, excesso, multa))
